...
class NetworkSynchronizer {
    ...
    async startSynchronization(roomId) {
        ...
        // Initialize game state structure if host
    ...
    setupGameStateListeners() {
        ...
        const playersRef = this.gameStateRef.child('players');
        ...
        eventsRef.on('child_added', (snapshot) => {
            ...
            if (event && event.playerId !== playerAuth.getCurrentUser()?.uid) {
    ...
    handleGameStateUpdate(gameState) {
        ...
        if (gameState.status === 'starting' && !this.gameStarting) {
